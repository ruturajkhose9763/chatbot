...
function pickBestVoice() {
  ...
  // Known high-quality "natural" voices, best first.
  const preferredNames = [
    'Google UK English Female', 'Google US English', 'Google हिन्दी', 'Google हिंदी',
...
if ('speechSynthesis' in window) {
  window.speechSynthesis.onvoiceschanged = () => { _cachedVoice = pickBestVoice(); };
...
function speakText(text, onDone) {
  ...
  const voice = _cachedVoice || pickBestVoice();
