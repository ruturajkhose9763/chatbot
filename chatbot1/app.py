...
DOCUMENTS_WORDS = ["document", "documents", "kagaz", "kagajpatra", "certificate", "certificates",
                    "papers needed", "paperwork", "कागदपत्र", "दस्तऐवज"]
...
INTENTS = [
    ...
    {"name": "why_choose_us", "keywords": [
        ...
        "college ke fayde", "college ki khasiyat", "काय खास आहे", "प्रवेश का घ्यावा"],
    ...
    {"name": "seats", "keywords": ["seat", "seats", "kitni seat", "intake", "student", "students", "kitne student",
                     "kitne students", "how many student", "how many students", "bacche kitne",
...
def ai_hybrid_reply(message, data, history=None):
    ...
    try:
        ...
        system_prompt = (
            ...
            "knowledge, casual chat, a quick calculation, etc.), it's fine to answer it yourself "
            "using your own knowledge — just never invent or guess specific college facts "
            "(fees, seats, staff names, dates) that aren't in the data below; for those, say "
            "you don't have that information and suggest contacting the college office. "
...
def openrouter_reply(message, data, history=None):
    ...
    try:
        ...
        system_prompt = (
            ...
            f"a math question, casual chat), it's fine to answer it yourself using your own "
            f"knowledge — just don't invent or guess any college-specific facts (fees, seats, "
            f"staff names, dates) that aren't in the data above. "
            f"Keep reply short (under 80 words), friendly, in Hinglish/English."
        )
        messages = [{"role": "system", "content": system_prompt}]
...
def get_reply_with_suggestions(message):
    ...
    guessed_intent_name = ai_classify_intent(message, history=_history_get())
