...
def translate_text(text, target_lang):
    ...
    try:
        import requests
        prompt = (
            f"Translate the following college chatbot reply into natural, "
            f"conversational {lang_name} (Devanagari script). Keep it short and "
...
def admin_dashboard():
    ...
    return render_template(
        ...
        subjects_data=subjects_data, dash_stats=dash_stats
    )
