...
def _send_teacher_otp_sms(mobile, otp):
    ...
    try:
        ...
        print("Teacher OTP SMS failed:", exc)
        return False
...
def login():
    ...
    if request.method == "POST":
        ...
        if account and check_password_hash(account["password_hash"], password):
            if account.get("role") == "staff" and account.get("mobile") and not account.get("mobile_verified", False):
                flash("Teacher mobile verification is pending. Verify the registered mobile number first.")
                return redirect(url_for("teacher_verify", username=account.get("username")))
